 ...
 */
(function () {
    if (document.body.classList.contains('octocart-cart') || document.body.classList.contains('octocart-checkout') || window.innerWidth < 768 || !document.getElementById('site-header-cart')) {
        return;
    }
