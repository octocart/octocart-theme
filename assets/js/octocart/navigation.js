...
(function () {
    ...
    jQuery(window).load(function () {
        jQuery('.octocart-handheld-footer-bar .search > a').click(function (e) {
    ...
    jQuery('.main-navigation, .secondary-navigation').find('a').on('focus.octocart blur.octocart', function () {
        jQuery(this).parents().toggleClass('focus');
    });

    // Add focus to cart dropdown
    jQuery(window).load(function () {
        jQuery('.site-header-cart').find('a').on('focus.octocart blur.octocart', function () {
            jQuery(this).parents().toggleClass('focus');
        });
    });
